  ...
  namespace {
    ...
    void renderMoonUI(int idx) {
      ...
      if (ImGui::TreeNode(headerLabel)) {
        ...
        RemixGui::DragFloat("Angular Radius", bindings.pAngularRadius, 0.1f, 0.1f, 30.0f, "%.1f deg", sliderFlags);
        ...
        RemixGui::DragFloat("Elevation", bindings.pElevation, 0.1f, -90.0f, 90.0f, "%.1f deg", sliderFlags);
        ...
        RemixGui::DragFloat("Rotation",  bindings.pRotation,  0.1f, 0.0f, 360.0f, "%.1f deg", sliderFlags);
    ...
    void renderSunUI() {
      ...
      if (ImGui::TreeNode("Sun")) {
        ...
        RemixGui::DragFloat("Texture Size", &RtxOptions::celestialTextureSizeDegObject(), 0.01f, 0.0f, 30.0f, "%.2f deg", sliderFlags);
        RemixGui::SetTooltipToLastWidgetOnHover(
